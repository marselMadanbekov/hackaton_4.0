$(document).ready(function () {
    const salesChartCanvas = document.getElementById('area-chart-bishkek');
    const prevMonthButton = document.getElementById('prevMonthBishkek');
    const nextMonthButton = document.getElementById('nextMonthBishkek');
    let month = 0;
    let salesChart = null;
    ...
    function updateChart() {
        ...
        $.ajax({
            url: `http://192.168.43.33:8082/api/region/бишкек?month=` + month,
            method: 'GET',
            dataType: 'json',
