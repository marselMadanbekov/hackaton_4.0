$(document).ready(function () {
    const salesChartCanvas = document.getElementById('area-chart-jal');
    const prevMonthButton = document.getElementById('prevMonthJal');
    const nextMonthButton = document.getElementById('nextMonthJal');
    let month = 0;
    let salesChart = null;
    ...
    function updateChart() {
        ...
        $.ajax({
            url: `http://192.168.43.33:8082/api/region/жалал-абад?month=` + month,
            method: 'GET',
            dataType: 'json',
