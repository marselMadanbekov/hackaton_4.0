$(document).ready(function () {
    const salesChartCanvas = document.getElementById('area-chart-naryn');
    const prevMonthButton = document.getElementById('prevMonthNaryn');
    const nextMonthButton = document.getElementById('nextMonthNaryn');
    let month = 0;
    let salesChart = null;
    ...
    function updateChart() {
        ...
        $.ajax({
            url: `http://192.168.43.33:8082/api/region/нарын?month=` + month,
            method: 'GET',
            dataType: 'json',
