$(document).ready(function () {
    const salesChartCanvas = document.getElementById('area-chart-osh');
    const prevMonthButton = document.getElementById('prevMonthOsh');
    const nextMonthButton = document.getElementById('nextMonthOsh');
    let month = 0;
    let salesChart = null;
    ...
    function updateChart() {
        ...
        $.ajax({
            url: `http://192.168.43.33:8082/api/region/ош?month=` + month,
            method: 'GET',
            dataType: 'json',
